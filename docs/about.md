...
```json
"dependencies": {
	"@dpowxconsensus/typechain-compiler": "^0.5.16",
...
```bash
$ npx @dpowxconsensus/typechain-compiler --config typechain.config.json
```
...
```bash
$ npm install @dpowxconsensus/typechain-polkadot
```
...
```bash
$ npx @dpowxconsensus/typechain-polkadot --in ./artifacts --out ./typechain-generated
```
